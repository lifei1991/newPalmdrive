<template>
  <div class="seed-plan">
    ...
    <div v-if="!isMobile" class="web-div">
      ...
      <div class="banner2-div">
        <div class="seed-plan-intro1">
          ...
          <div class="intro1-title2">2600+同学的选择，多年背景提升，申请水到渠成。</div>
      ...
      <div class="banner3-div">
        ...
        <div class="title2">2600+同学的选择，多年背景提升，申请水到渠成。</div>
    ...
    <div v-if="isMobile" class="mobile-div">
        ...
        <div class="teachers-div">
          <template v-for="(item, index) in selectedTeacher" >
            <div class="each-teacher" v-if="index < 8" :key="item.school" @click="handleOpenDialog(item)">
              <div class="teacher-img" :style="{backgroundImage:'url(' + item.img + ')'}"></div>
              <div class="teacher-info-div" :style="{'background-color':(currentType == 2 ? '#FEE51F':'#35C4C4')}">
                <div class="teacher-name">{{ item.name }}</div>
                <div class="teacher-school">{{ item.phdSchool ? item.phdSchool : item.school }}</div>
              </div>
            </div>
      ...
      <transition name="slide-fade">
        <div v-if="show" class="banner4-div" :style="{backgroundImage:'url(' + banner6 + ')'}">
            <div class="ask-div">
                <div class="ercode" :style="{backgroundImage:'url(' + askErcode + ')'}"></div>
                <div class="ask-text">
                    <div class="text1">想要了解更多导师信息和留学服务内容，可扫码咨询留学小助手。</div>
      ...
      <div class="banner5-div">
        <div class="title">种子计划优势</div>
        <div v-for="item in advantages" :key="item.img" class="advantage-div">
          <div class="advantage-img" :style="{backgroundImage:'url(' + item.imgMB + ')'}"></div>
        </div>
      </div>
      ...
      <div class="banner6-div">
          ...
          <div class="demo-div2">
              <div class="each-demo-div2"  v-for="item in demos2" :key="item.img">
                  <div class="demo-img" :style="{backgroundImage:'url(' + item.imgMB + ')'}"></div>
                  <div class="demo-title">{{ item.title }}</div>
                  <div class="demo-text">{{ item.text }}</div>
              </div>
          </div>
...
export default {
  ...
  created () {
    ...
    this.banner1 = this.isMobile ? require('../assets/img/seedPlan/mobile/banner1.png') : require('../assets/img/seedPlan/banner1.png')
...
.seed-plan {
  ...
  .mobile-div {
    ...
    .banner3-div {
      ...
      .title2 {
        margin: 0.346667rem auto 0.32rem;
        width: 8.08rem;
        font-size: 0.32rem;
        font-family: Biko, SourceHanSansCN;
        font-weight: 500;
      ...
      .teacher-item-div {
          ...
          li {
            ...
            .img {
              ...
              border-radius:50%;
              opacity:1;
              margin: 0.213333rem auto 0.2rem;
              background-repeat: no-repeat;
              background-size: cover;
            }
          }
      ...
      .teachers-div {
        ...
        .each-teacher {
          ...
          .teacher-info-div {
            ...
            padding: 0.346667rem 0.426667rem 0.18rem;
            text-align: left;
    ...
    .banner6-div {
      ...
      .title2 {
        ...
        color:rgba(60,60,60,1);
        opacity:1;
        margin: 0.533333rem auto 1.333333rem;
      }
      ...
      .demo-div1 {
        ...
        .each-demo-div1 {
          width: 7.493333rem;
          display: inline-block;
          margin: 0.666667rem auto 1.6rem;
          vertical-align: top;
          background:rgba(243,246,251,1);
          box-shadow:0px 3px 6px rgba(0,0,0,0.16);
          border-radius:15px;
          ...
          .demo-text {
              width: 4.373333rem;
              margin: 0.133333rem auto 0.8rem;
              font-size:0.32rem;
              font-family:SourceHanSansCN, Campton;
              font-weight:400;
              line-height:0.426667rem;
      ...
      .demo-div2 {
        ...
        .each-demo-div2 {
          width: 3.333333rem;
          display: inline-block;
          margin: 0 0.666667rem 0.666667rem;
          vertical-align: top;
          // background:rgba(243,246,251,1);
          // box-shadow:0px 3px 6px rgba(0,0,0,0.16);
          // border-radius:15px;
          ...
          .demo-title {
              margin: 0.453333rem 0 0.346667rem;
              font-size:0.373333rem;
              font-family:SourceHanSansCN;
              font-weight:bold;
              line-height:0.373333rem;
